...
extern "C" JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved)
{
  ...
  jclass cMain = env->FindClass("net/matricom/xbmc/Main");
  if(cMain)
  {
  ...
  jclass cBroadcastReceiver = env->FindClass("net/matricom/xbmc/XBMCBroadcastReceiver");
  ...
  jclass cFrameAvailableListener = env->FindClass("net/matricom/xbmc/XBMCOnFrameAvailableListener");
