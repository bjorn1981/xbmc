...
CXBMCApp::CXBMCApp(ANativeActivity* nativeActivity)
  ...
  , CJNIBroadcastReceiver("net.matricom.xbmc/XBMCBroadcastReceiver")
  , m_wakeLock(NULL)
{
...
bool CXBMCApp::getWakeLock()
{
  ...
  m_wakeLock = new CJNIWakeLock(CJNIPowerManager(getSystemService("power")).newWakeLock("net.matricom.xbmc"));
...
void CXBMCApp::SetupEnv()
{
  ...
  if (!androidPath)
    androidPath = getDir("net.matricom.xbmc", 1);
